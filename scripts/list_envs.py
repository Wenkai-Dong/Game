...
importlib.import_module("game.tasks")
...
def main() -> None:
    ...
    parser.add_argument("--keyword", default="Game-", help="Substring used to filter task ids.")
    ...
    table.title = "Available game Environments"
