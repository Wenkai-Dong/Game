...
Task families live in `src/game/tasks`. Within a manager-based family, task-wide MDP terms live in `mdp`, while
...
`src/game/ui_extension_example.py` through `config/extension.toml`.
